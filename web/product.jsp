    ...
    <body>
        ...
        <div class="container_middle">
            <c:forEach var="product" items="${products}">
                <div class="container_product" style="display: none;">
                    <div class="container_product_image">
                        <img alt="${product.productDescription}" src="image/default/question_mark.png" />
                    </div>
                    <div class="container_product_details">
                        <div class="container_product_holder_basket">
                            <img onclick="shopObj.addProductToCart(${product.productId})" src="image/default/silk/basket.png" />
                        </div>
                        <div class="container_product_holder_name">
                            ${product.productName}
                        </div>
                        <div class="container_product_holder_price">
                            <fmt:formatNumber type="CURRENCY" value="${product.productPrice}" />
                        </div>
                    </div>
                </div>
            </c:forEach>
