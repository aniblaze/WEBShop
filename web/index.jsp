...
<html>
    ...
    <body>
        ...
        <div class="container_middle">
            Welcome to WEB-shop. Feel free to browse around the four pages 
            available to you. The products page will allow you to put products
            in your basket, the account page will show an order overview, and
            the shopping cart will allow you to purchase the products which you
            placed in your basket earlier.
            <br />
            <br />
            In terms of techniques: AJAX has been implemented using the
            open-source library 'jQuery', click on the login text in the
            top-right corner to see some of it in acion. The rest is a
            combination of java beans, hibernate, DAO, and such. Feel free to
            browse around the code as you see fit. Comments are plenty, but feel
            free to send me an e-mail at
            <a href="mailto:stefan.van.beusekom@gmail.com">stefan.van.beusekom@gmail.com</a>
            if you feel the commentary quality is coming up short.
            <br />
            <br />
            Kind regards,<br />
            Stefan
